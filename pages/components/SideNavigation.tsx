...
const SideNavigation = () => {
  return (
    <nav>
      <ul className='pr-12'>
        <li className='flex mt-10 cursor-pointer hover:text-[#414455] duration-150 items-center justify-between'>
          <span className='flex items-center'>
            ...
            <span className='text-base text-[#696D8C] hover:text-[#6837EF]'>
              Admin
            </span>
          </span>
        ...
        <li className='flex mt-10 cursor-pointer hover:text-[#6837EF] duration-150 items-center justify-between'>
          <span className='flex items-center'>
            <svg
              className='mr-4'
              width='16'
        ...
        <li className='flex mt-10 cursor-pointer hover:text-[#6837EF] duration-150 items-center justify-between'>
          <span className='flex items-center'>
            ...
            <span className='text-base text-[#6837EF]'>Analytics</span>
          </span>
        ...
        <ul className='flex flex-col'>
          <li className='flex flex-col mt-5 ml-4 cursor-pointer hover:text-[#414455] duration-150 '>
            <span className='border-l border-gray-300 text-base text-black pl-4 '>
              Teams
            </span>
          </li>
          <li className='flex flex-col mt-2 ml-4 cursor-pointer hover:text-[#414455] duration-150'>
            <span className='text-base text-[#696D8C] pl-4 '>
              Knowledge Base
            </span>
          </li>
          <li className='flex flex-col mt-2 ml-4 cursor-pointer hover:text-[#414455] duration-150'>
            <span className='text-base text-[#696D8C] pl-4 '>Training SAM</span>
          </li>
          <li className='flex flex-col mt-2 ml-4 cursor-pointer hover:text-[#414455] duration-150'>
            <span className='text-base text-[#696D8C] pl-4 '>Help Center</span>
          </li>
        </ul>
      </ul>
    </nav>
